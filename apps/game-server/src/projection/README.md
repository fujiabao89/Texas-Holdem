...
TEX-53：完整视图与逐事件 patch 的 D/SB/BB 读取当前 hand，SB/BB 无手为 null，保留手末座位直至下一手。`blind-seats.test.ts` 覆盖 2/3/6/10 人、空位、撤回、真实全下淘汰、跨手与恢复；规则与 nullable 语义仅在 [协议规格](../../../../docs/02-protocol-spec.md) §9.2 维护。
