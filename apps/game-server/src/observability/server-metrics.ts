...
export const N = {
  ...
  registeredRooms: "texas_registered_rooms",
  closedRoomTombstones: "texas_closed_room_tombstones",
  registeredTournaments: "texas_registered_tournaments",
  finishedRetainedTournaments: "texas_finished_retained_tournaments",
  frozenTournaments: "texas_frozen_tournaments",
  persistenceRegisteredQueues: "texas_persistence_registered_queues",
...
const DEFS: readonly MetricDef[] = [
  ...
  {
    name: N.http5xx,
    help: "HTTP 5xx 业务/服务端错误响应总数（按方法）",
    kind: "counter",
    labelNames: ["method"],
  },
  {
    name: N.httpDurationSeconds,
    help: "HTTP 请求处理耗时",
    kind: "histogram",
    labelNames: ["method"],
  },
  ...
  {
    name: N.wsClosed,
    help: "WebSocket 关闭总数（分类：normal/replaced/abnormal/auth_failed/other）",
    kind: "counter",
    labelNames: ["category"],
  },
  { name: N.wsActive, help: "当前活跃（已认证）WebSocket 连接数", kind: "gauge", labelNames: [] },
  {
    name: N.wsMessagesWritten,
    help: "写入 WS 的服务端消息总数（按消息类型）",
    kind: "counter",
    labelNames: ["type"],
  },
  {
    name: N.wsMessageBytes,
    help: "写入 WS 的消息字节总数（按消息类型）",
    kind: "counter",
    labelNames: ["type"],
  },
  { name: N.reconnectAttempts, help: "WS 认证/重连尝试总数", kind: "counter", labelNames: [] },
  {
    name: N.reconnectSuccess,
    help: "WS 认证/重连成功总数（resumed: 房间存活期内是否已认证过）",
    kind: "counter",
    labelNames: ["resumed"],
  },
  {
    name: N.reconnectFailure,
    help: "WS 认证/重连失败总数（按错误码，集合有界）",
    kind: "counter",
    labelNames: ["code"],
  },
  {
    name: N.reconnectRecoverySeconds,
    help: "认证至首个完整 Snapshot(RECONNECT_RESULT) 恢复耗时",
    kind: "histogram",
    labelNames: [],
  },
  {
    name: N.actions,
    help: "提交的 SUBMIT_ACTION 结果（status: APPLIED/REJECTED；code 为拒绝原因码或 OK）",
    kind: "counter",
    labelNames: ["status", "code"],
  },
  {
    name: N.actionToEventSeconds,
    help: "Action 进入服务端(Schema+身份校验后)至结果/事件写入 WS 的耗时（按 status）",
    kind: "histogram",
    labelNames: ["status"],
  },
  {
    name: N.engineCriticalErrors,
    help: "Engine Critical Error（不变量违反冻结）总数",
    kind: "counter",
    labelNames: [],
  },
  {
    name: N.persistenceIntegrityErrors,
    help: "持久化完整性错误（隔离）总数",
    kind: "counter",
    labelNames: [],
  },
  {
    name: N.persistenceQueueItems,
    help: "持久化待提交队列积压 bundle 数",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.persistenceQueueBytes,
    help: "持久化待提交队列积压字节数",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.persistenceQueueOldestSeconds,
    help: "持久化队列最旧项等待秒数",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.persistenceWatermarkLevel,
    help: "持久化水位（0=ok/1=soft/2=hard）",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.persistenceDegraded,
    help: "持久化降级门控（1=拒新建/soft+，0=正常）",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.persistenceQuarantined,
    help: "持久化隔离（数据损坏）的锦标赛数",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.persistenceLastDbLatencySeconds,
    help: "最近一次持久化 DB 写入耗时",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.persistenceConsecutiveFailures,
    help: "持久化连续失败计数（瞬态退避用）",
    kind: "gauge",
    labelNames: [],
  },
  { name: N.activeRooms, help: "当前活跃 Room 数", kind: "gauge", labelNames: [] },
  {
    name: N.activeTournaments,
    help: "当前 RUNNING Tournament 数（不含终局保留或冻结）",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.registeredRooms,
    help: "当前驻留的重型 Room 运行时数（含关闭排空中）",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.closedRoomTombstones,
    help: "CLOSED Room 轻量 tombstone 数（10分钟保留）",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.registeredTournaments,
    help: "驻留的 Tournament 运行时总数",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.finishedRetainedTournaments,
    help: "终局只读保留中的 Tournament 数",
    kind: "gauge",
    labelNames: [],
  },
  { name: N.frozenTournaments, help: "冻结待诊断的 Tournament 数", kind: "gauge", labelNames: [] },
  {
    name: N.persistenceRegisteredQueues,
    help: "仍驻留的 Tournament Writer 队列数",
    kind: "gauge",
    labelNames: [],
  },
  ...
  {
    name: N.processCpuRatio,
    help: "进程 CPU 占用率（最近采样窗口，0..1/核）",
    kind: "gauge",
    labelNames: [],
  },
  {
    name: N.eventLoopLagSeconds,
    help: "事件循环滞后（上一采样周期实际耗时 - 期望）",
    kind: "gauge",
    labelNames: [],
  },
