...
TEX-57：牌角不再铺设白色背景，点阵与 A/J/Q/K 内容统一收进牌面安全区；7–10 使用适配小尺寸 Seat 的紧凑点阵，人头牌边框固定为中性色，不继承红/黑花色造成颜色污染。四个验收视口的真实字体几何、红黑语义与角标透明背景由 [cards E2E](../../../../../tests/e2e/cards/README.md) 检查。
