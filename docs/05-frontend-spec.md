...
- TEX-46（2026-09-16）：牌桌页收敛为单一视口，取代 TEX-25/TEX-45 记录的“手机允许纵向滚动至操作区”。站点页头之外的剩余高度归页面所有，牌桌在剩余空间内按 `--felt-ratio` 自适应，并固定预留 `--dock-reserve` 给操作区；操作区因此只出现在本人 Seat 前方的牌桌下沿，且出现与消失都不改变牌桌几何。为容纳更矮的牌桌，6 人以上的手机与桌面牌桌压缩 Seat 卡片，8 人以上重排纵向分层；本手结果与终局排名改为浮于牌桌之上的覆盖层。牌面尺寸、Deck/Board 几何、发牌/翻牌/派奖时序、动画关键帧与音效不变。
