...
| `pnpm test:sim -- --seed <n>` | Simulation | `tests/simulator` | 独立 Node CLI（[tests/simulator/README.md](./simulator/README.md)） |
...
| [simulator/](./simulator) | Headless Simulator 入口（长跑主循环由 TEX-16 实现） |
