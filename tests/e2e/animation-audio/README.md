...
- TEX-46 小牌：1366×768 桌面、360×800 竖屏、844×390 横屏，检查公共牌、本人手牌、摊牌候选/最佳五张、静态结算与对手亮牌的牌值/花色文字边界不相交且不溢出牌框；覆盖 A/J/Q/K/10 与红黑花色，保留阶段截图。最佳五张截图使用 Playwright 的 `animations: "disabled"` 完成 CSS 动画，仅用于观察最终牌面排版，不代替既有动画时序回归。
